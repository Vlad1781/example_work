# 1 "0_Src/0_AppSw/Tricore/TIM/TIM.c"
...
# 2 "0_Src/0_AppSw/Tricore/TIM/TIM.c" 2
...
# 3 "0_Src/0_AppSw/Tricore/TIM/TIM.c" 2
...
# 4 "0_Src/0_AppSw/Tricore/TIM/TIM.c" 2
# 1 "0_Src/0_AppSw/Tricore/TIM/TIM.h" 1
void MAF_TIMs_init(void);
uint16 get_MAF1_freq(void);
uint16 get_MAF_freq(void);
uint32 get_Turbo_speed(void);
uint32 get_Height_duty1(void);
uint32 get_Height_duty2(void);
uint32 get_Height_duty3(void);
uint32 get_Height_duty4(void);
# 5 "0_Src/0_AppSw/Tricore/TIM/TIM.c" 2
...
void ChannelInit();
# 7 "0_Src/0_AppSw/Tricore/TIM/TIM.c" 2
# 20 "0_Src/0_AppSw/Tricore/TIM/TIM.c"
void MAF_TIMs_init(void)
{
     volatile Ifx_SRC_SRCR *srcr;
# 36 "0_Src/0_AppSw/Tricore/TIM/TIM.c"
         (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF0101024u).B.TIM_MODE = 0;
      (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF0101024u).B.GPR0_SEL = 3;
      (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF0101024u).B.GPR1_SEL = 3;
      (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF0101024u).B.DSL = 0;
      (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF0101024u).B.CLK_SEL= 2;
      (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF0101024u).B.FLT_EN=1;
      (*(volatile Ifx_GTM_TIM_CH_CNT *)0xF0101008u).U = 0;
      (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF0101024u).B.TIM_EN = 1;
      (*(volatile Ifx_GTM_IRQ_MODE *)0xF010001Cu).B.IRQ_MODE = 2;
      (*(volatile Ifx_GTM_TIM_CH_IRQ_MODE *)0xF0101038u).B.IRQ_MODE = 2;

      (*(volatile Ifx_GTM_TIM_CH_FLT_RE *)0xF010101Cu) .U = 40;
      (*(volatile Ifx_GTM_TIM_CH_FLT_FE *)0xF0101020u) .U = 40;

      IfxGtm_PinMap_setTimTin(&IfxGtm_TIM0_0_TIN18_P00_9_IN, IfxPort_InputMode_noPullDevice);


     (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF01010A4u).B.TIM_MODE = 0;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF01010A4u).B.GPR0_SEL = 3;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF01010A4u).B.GPR1_SEL = 3;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF01010A4u).B.DSL = 0;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF01010A4u).B.CLK_SEL= 2;
  (*(volatile Ifx_GTM_TIM_CH_CNT *)0xF0101088u).U = 0;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF01010A4u).B.TIM_EN = 1;

  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF01010A4u).B.FLT_EN=1;
  (*(volatile Ifx_GTM_TIM_CH_FLT_RE *)0xF010109Cu) .U = 40;
  (*(volatile Ifx_GTM_TIM_CH_FLT_FE *)0xF01010A0u) .U = 40;



     (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF0101124u).B.TIM_MODE = 0;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF0101124u).B.GPR0_SEL = 3;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF0101124u).B.GPR1_SEL = 3;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF0101124u).B.DSL = 0;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF0101124u).B.CLK_SEL= 2;
  (*(volatile Ifx_GTM_TIM_CH_CNT *)0xF0101108u).U = 0;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF0101124u).B.TIM_EN = 1;

  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF0101124u).B.FLT_EN=1;
  (*(volatile Ifx_GTM_TIM_CH_FLT_RE *)0xF010111Cu) .U = 40;
  (*(volatile Ifx_GTM_TIM_CH_FLT_FE *)0xF0101120u) .U = 40;




  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF01011A4u).B.TIM_MODE = 0;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF01011A4u).B.GPR0_SEL = 3;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF01011A4u).B.GPR1_SEL = 3;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF01011A4u).B.DSL = 0;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF01011A4u).B.CLK_SEL= 2;
  (*(volatile Ifx_GTM_TIM_CH_CNT *)0xF0101188u).U = 0;
  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF01011A4u).B.TIM_EN = 1;

  (*(volatile Ifx_GTM_TIM_CH_CTRL *)0xF01011A4u).B.FLT_EN=1;
  (*(volatile Ifx_GTM_TIM_CH_FLT_RE *)0xF010119Cu) .U = 40;
  (*(volatile Ifx_GTM_TIM_CH_FLT_FE *)0xF01011A0u) .U = 40;
...
uint32 get_Height_duty1(void)
{
  ...
  uint32 Cnts;
  uint32 Duty;
  PeriodFull=(0x00FFFFFF & (*(volatile Ifx_GTM_TIM_CH_GPR1 *)0xF0101004u).U);
  PeriodEdge=(0x00FFFFFF & (*(volatile Ifx_GTM_TIM_CH_GPR0 *)0xF0101000u).U);
  Cnts=(0x00FFFFFF & (*(volatile Ifx_GTM_TIM_CH_CNT *)0xF0101008u).U);

  if( (PeriodFull>PeriodEdge) && (PeriodFull!=0)) Duty= PeriodEdge*1000/PeriodFull;
  if((Cnts>650000)||(Cnts<100)) Duty=IfxPort_getPinState(&((*(Ifx_P *)0xF003A000u)),9)*1000;
 return Duty;
}
...
uint32 get_Height_duty2(void)
{
   ...
   uint32 Cnts;
   uint32 Duty;
   PeriodFull=(0x00FFFFFF & (*(volatile Ifx_GTM_TIM_CH_GPR1 *)0xF0101084u).U);
   PeriodEdge=(0x00FFFFFF & (*(volatile Ifx_GTM_TIM_CH_GPR0 *)0xF0101080u).U);
   Cnts=(0x00FFFFFF & (*(volatile Ifx_GTM_TIM_CH_CNT *)0xF0101088u).U);

   if( (PeriodFull>PeriodEdge) && (PeriodFull!=0)) Duty= PeriodEdge*1000/PeriodFull;
   if((Cnts>650000)||(Cnts<100)) Duty=IfxPort_getPinState(&((*(Ifx_P *)0xF003A000u)),10)*1000;
  return Duty;
}
...
uint32 get_Height_duty3(void)
{
   ...
   uint32 Cnts;
   uint32 Duty;
   PeriodFull=(0x00FFFFFF & (*(volatile Ifx_GTM_TIM_CH_GPR1 *)0xF0101104u).U);
   PeriodEdge=(0x00FFFFFF & (*(volatile Ifx_GTM_TIM_CH_GPR0 *)0xF0101100u).U);
   Cnts=(0x00FFFFFF & (*(volatile Ifx_GTM_TIM_CH_CNT *)0xF0101108u).U);

   if( (PeriodFull>PeriodEdge) && (PeriodFull!=0)) Duty= PeriodEdge*1000/PeriodFull;
   if((Cnts>650000)||(Cnts<100)) Duty=IfxPort_getPinState(&((*(Ifx_P *)0xF003A000u)),11)*1000;
  return Duty;
...
uint32 get_Height_duty4(void)
{
   ...
   uint32 Cnts;
   uint32 Duty;
   PeriodFull=(0x00FFFFFF & (*(volatile Ifx_GTM_TIM_CH_GPR1 *)0xF0101184u).U);
   PeriodEdge=(0x00FFFFFF & (*(volatile Ifx_GTM_TIM_CH_GPR0 *)0xF0101180u).U);
   Cnts=(0x00FFFFFF & (*(volatile Ifx_GTM_TIM_CH_CNT *)0xF0101188u).U);

   if( (PeriodFull>PeriodEdge) && (PeriodFull!=0)) Duty= PeriodEdge*1000/PeriodFull;
   if((Cnts>650000)||(Cnts<100)) Duty=IfxPort_getPinState(&((*(Ifx_P *)0xF003A000u)),12)*1000;
  return Duty;
