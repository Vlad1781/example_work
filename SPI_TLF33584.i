# 1 "0_Src/0_AppSw/Tricore/TLF33584/SPI_TLF33584.c"
...
# 11 "./0_Src/0_AppSw/Tricore/Main/Channelinit.h"
...
# 12 "./0_Src/0_AppSw/Tricore/Main/Channelinit.h" 2
...
void ChannelInit();
# 9 "0_Src/0_AppSw/Tricore/TLF33584/SPI_TLF33584.c" 2
...
# 10 "0_Src/0_AppSw/Tricore/TLF33584/SPI_TLF33584.c" 2
...
# 11 "0_Src/0_AppSw/Tricore/TLF33584/SPI_TLF33584.c" 2
# 1 "0_Src/0_AppSw/Tricore/TLF33584/SPI_TLF33584.h" 1
# 9 "0_Src/0_AppSw/Tricore/TLF33584/SPI_TLF33584.h"
 void QSPI2_init(void);
# 12 "0_Src/0_AppSw/Tricore/TLF33584/SPI_TLF33584.c" 2
# 89 "0_Src/0_AppSw/Tricore/TLF33584/SPI_TLF33584.c"
void QSPI0_init()
{

 unsigned int endinit_pw, endinitSfty_pw;
 endinit_pw = IfxScuWdt_getCpuWatchdogPassword();
 endinitSfty_pw = IfxScuWdt_getSafetyWatchdogPassword();


 IfxScuWdt_clearCpuEndinit(endinit_pw);
 (*(volatile Ifx_QSPI_CLC *)0xF0001C00u).U=0x8;
 IfxScuWdt_setCpuEndinit(endinit_pw);

 Ifx_QSPI_GLOBALCON Temp_QSPI_GLOBALCON;
 Temp_QSPI_GLOBALCON.B.TQ=4;
 Temp_QSPI_GLOBALCON.B.AREN=1;
 Temp_QSPI_GLOBALCON.B.EXPECT=15;
 Temp_QSPI_GLOBALCON.B.MS=0;
   (*(volatile Ifx_QSPI_GLOBALCON *)0xF0001C10u)=Temp_QSPI_GLOBALCON;


 Ifx_QSPI_PISEL Temp_QSPI_PISEL;
 Temp_QSPI_PISEL.B.MRIS=2;



 (*(volatile Ifx_QSPI_PISEL *)0xF0001C04u)=Temp_QSPI_PISEL;

 Ifx_QSPI_GLOBALCON1 Temp_QSPI_GLOBALCON1;
 Temp_QSPI_GLOBALCON1.B.TXFM=1;
 Temp_QSPI_GLOBALCON1.B.RXFM=1;
   (*(volatile Ifx_QSPI_GLOBALCON1 *)0xF0001C14u)=Temp_QSPI_GLOBALCON1;


 Ifx_QSPI_ECON Temp_QSPI_ECON;
 Temp_QSPI_ECON.B.PAREN=0;
 Temp_QSPI_ECON.B.Q=0x13;
 Temp_QSPI_ECON.B.B=0;
 Temp_QSPI_ECON.B.C=1;
 Temp_QSPI_ECON.B.CPH=0;
 Temp_QSPI_ECON.B.CPOL=0;
   (*(volatile Ifx_QSPI_ECON *)0xF0001C20u)=Temp_QSPI_ECON;


 Ifx_QSPI_SSOC Temp_QSPI_SSOC;
 Temp_QSPI_SSOC.B.OEN=(1<<0);
 Temp_QSPI_SSOC.B.AOL=0;
   (*(volatile Ifx_QSPI_SSOC *)0xF0001C48u)=Temp_QSPI_SSOC;


Ifx_QSPI_BACON Temp_QSPI_BACON;
Temp_QSPI_BACON.B.LAST=1;
Temp_QSPI_BACON.B.LPRE=2;
Temp_QSPI_BACON.B.BYTE=0;
Temp_QSPI_BACON.B.DL=0xF;
Temp_QSPI_BACON.B.MSB=1;
Temp_QSPI_BACON.B.CS=0x0;
Temp_QSPI_BACON.B.TRAIL=0;
Temp_QSPI_BACON.B.TPRE=2;
Temp_QSPI_BACON.B.IPRE=2;
 (*(volatile Ifx_QSPI_BACONENTRY *)0xF0001C60u).U=Temp_QSPI_BACON.U;
...
unsigned short Send16bitToTLF33584(unsigned short transmit_word)
{

 unsigned short received_word;



  (*(volatile Ifx_QSPI_DATAENTRY *)0xF0001C64u).U=transmit_word;
  while ((*(volatile Ifx_QSPI_STATUS *)0xF0001C40u).B.TXF !=1);
  (*(volatile Ifx_QSPI_FLAGSCLEAR *)0xF0001C54u).B.TXC=1;
  while ((*(volatile Ifx_QSPI_STATUS *)0xF0001C40u).B.RXF !=1);
  (*(volatile Ifx_QSPI_FLAGSCLEAR *)0xF0001C54u).B.RXC=1;
  received_word=(*(volatile Ifx_QSPI_RXEXIT *)0xF0001C90u).U;
