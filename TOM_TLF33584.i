# 1 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.c"
# 1 "C:\\SCU\\Project_AU_C//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.c"
# 28 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.c"
# 1 "./0_Src/0_AppSw/Tricore/Main/global_pars_vars_manual.h" 1
# 29 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.c" 2
# 1 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.h" 1
# 36 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.h"
...
# 37 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.h" 2
...
# 1 "./0_Src/1_SrvSw/Tricore/StdIf/IfxStdIf_Timer.h" 1
# 52 "./0_Src/1_SrvSw/Tricore/StdIf/IfxStdIf_Timer.h"
# 1 "./0_Src/1_SrvSw/Tricore/StdIf/IfxStdIf.h" 1
# 97 "./0_Src/1_SrvSw/Tricore/StdIf/IfxStdIf.h"
typedef void *IfxStdIf_InterfaceDriver;
# 53 "./0_Src/1_SrvSw/Tricore/StdIf/IfxStdIf_Timer.h" 2
...
# 135 "./0_Src/1_SrvSw/Tricore/StdIf/IfxStdIf_Timer.h"
typedef void (*IfxStdIf_Timer_ApplyUpdate)(IfxStdIf_InterfaceDriver driver);
# 152 "./0_Src/1_SrvSw/Tricore/StdIf/IfxStdIf_Timer.h"
...
# 419 "./0_Src/1_SrvSw/Tricore/StdIf/IfxStdIf_Timer.h"
...
# 39 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.h" 2
...
void OutoutPWMInit_TOM0_CH1(unsigned char k);



void OutPWMInit_TOM0_CH1(unsigned char k);
# 65 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.h"
typedef struct
{
    struct
    {
...
void gtm_pwm_gen(void);
void gtm_pwm_update(unsigned short period, unsigned short freq, unsigned short vector);
# 30 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.c" 2

# 1 "./0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu_Intrinsics.h" 1
# 32 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.c" 2
# 1 "./0_Src/4_McHal/Tricore/Scu/Std/IfxScuWdt.h" 1
# 33 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.c" 2
# 1 "./0_Src/4_McHal/Tricore/Port/Io/IfxPort_Io.h" 1
# 159 "./0_Src/4_McHal/Tricore/Port/Io/IfxPort_Io.h"
typedef struct
{
...
# 34 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.c" 2
...
# 35 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.c" 2

# 1 "./0_Src/0_AppSw/Tricore/TLE8718/MSC_TOM_init.h" 1
...
# 1 "./0_Src/4_McHal/Tricore/_Impl/IfxGtm_cfg.h" 1
# 9 "./0_Src/0_AppSw/Tricore/TLE8718/MSC_TOM_init.h" 2
...
typedef struct
{
 ...
 Ifx_GTM_TOM * tom;
 IfxGtm_Tom_Ch channel;
 Ifx_GTM_TOM_CH *tomCh;
} PWMInputchannelsptr;

void TOM_PWM_init(PWMInputchannelsptr* PWMout, unsigned char tomnum, unsigned char channelnum, uint32 period, uint32 duty, uint8 fxsel);
void set_TOM_pwm(PWMInputchannelsptr* PWMout, unsigned short duty, unsigned short period,unsigned short vector);
void set_TOM_pwm_percent(PWMInputchannelsptr* PWMout, uint16 percent, unsigned short vector);
void MSC_pwm_init(void);
void TOM_to_MCS_init(void);
void Set_Termostat1_pwm(uint16 percent);
void Set_LSU1heater_pwm(uint16 percent);
void Set_LSU2heater_pwm(uint16 percent);
void Set_InPhaser1_pwm(uint16 percent);
void Set_InPhaser2_pwm(uint16 percent);
void Set_ExPhaser1_pwm(uint16 percent);
void Set_ExPhaser2_pwm(uint16 percent);
void Set_WasteGate1_pwm(uint16 percent);
void Set_CoolerFan1_pwm(uint16 percent);
void Set_CoolPumpHV1_pwm(uint16 percent);
void Set_CoolPumpHV2_pwm(uint16 percent);
# 37 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.c" 2
# 85 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.c"
 PWMInputchannelsptr WDTout;
# 133 "0_Src/0_AppSw/Tricore/TLF33584/TOM_TLF33584.c"
void OutPWMInit_TOM1_CH7(void)
{
        Ifx_GTM_TOM_TGC* tgcpointer;
     Ifx_GTM_TOM * tom;
     IfxGtm_Tom_Ch channel=IfxGtm_Tom_Ch_7;
     tom = (Ifx_GTM_TOM*)((uint32)&(((*(Ifx_GTM *)0xF0100000u)).TOM[1]));
     tgcpointer = (Ifx_GTM_TOM_TGC *)&tom->TGC0_GLB_CTRL;
     Ifx_GTM_TOM_CH *tomCh = (Ifx_GTM_TOM_CH *)((uint32)&tom->CH0.CTRL.U + 0x40 * channel);



     WDTout.tgc = tgcpointer ;
     WDTout.tom = tom;
     WDTout.channel = channel;
     WDTout.tomCh = tomCh;



     ((*(volatile Ifx_GTM_INOUTSEL_T_OUTSEL *)0xF019FD40u)).B.SEL0 = 0;

     WDTout.tgc->ENDIS_CTRL.B.ENDIS_CTRL7 = 2;
     WDTout.tgc->ENDIS_STAT.B.ENDIS_STAT7 = 2;
     WDTout.tgc->OUTEN_CTRL.B.OUTEN_CTRL7 = 2;
     WDTout.tgc->OUTEN_STAT.B.OUTEN_STAT7 = 2;
     WDTout.tgc->GLB_CTRL.B.RST_CH7 = 1;
     WDTout.tgc->GLB_CTRL.B.UPEN_CTRL7 = 2;
     WDTout.tgc->FUPD_CTRL.B.FUPD_CTRL7 = 2;
     WDTout.tomCh->CTRL.B.CLK_SRC_SR = 3;
     WDTout.tomCh->CTRL.B.RST_CCU0 = 0;
     WDTout.tomCh->CTRL.B.TRIGOUT = 0;
     WDTout.tomCh->CTRL.B.OSM = 0;
     WDTout.tomCh->CTRL.B.GCM = 0;
     WDTout.tomCh->CTRL.B.SL = 0;
     WDTout.tomCh->CM0.B.CM0 = 1500;
     WDTout.tomCh->CM1.B.CM1= 750;
     WDTout.tomCh->CN0.B.CN0= 1494;
     WDTout.tomCh->SR0.B.SR0 = 1500;
     WDTout.tomCh->SR1.B.SR1=750;
