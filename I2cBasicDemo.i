# 1 "0_Src/0_AppSw/Tricore/I2C/I2cBasicDemo.c"
# 1 "C:\\SCU\\Project_AU_C//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Tricore/I2C/I2cBasicDemo.c"
# 35 "0_Src/0_AppSw/Tricore/I2C/I2cBasicDemo.c"
...
# 36 "0_Src/0_AppSw/Tricore/I2C/I2cBasicDemo.c" 2
...
# 37 "0_Src/0_AppSw/Tricore/I2C/I2cBasicDemo.c" 2
# 53 "0_Src/0_AppSw/Tricore/I2C/I2cBasicDemo.c"
App_I2cBasic g_I2cBasic;
# 66 "0_Src/0_AppSw/Tricore/I2C/I2cBasicDemo.c"
extern volatile int I2CBusStatus;
...
# 73 "0_Src/0_AppSw/Tricore/I2C/I2cBasicDemo.c" 2
...
#pragma section
# 74 "0_Src/0_AppSw/Tricore/I2C/I2cBasicDemo.c" 2
unsigned char acc_xyz[16];


void I2cModule_init(void)
{

    boolean interruptState = IfxCpu_disableInterrupts();


    g_I2cBasic.i2cAddr = 0x38;

    {
        ...
        const IfxI2c_Pins pins = {&IfxI2c0_SCL_P02_5_INOUT, &IfxI2c0_SDA_P02_4_INOUT, IfxPort_PadDriver_cmosAutomotiveSpeed3};
...

    {
        ...
        IfxSrc_init((Ifx_SRC_SRCR*)&((*(Ifx_SRC *)0xF0038000u)).I2C.I2C[0].P , IfxSrc_Tos_cpu0, 151);
             IfxSrc_enable((Ifx_SRC_SRCR*)&((*(Ifx_SRC *)0xF0038000u)).I2C.I2C[0].P);
...
# 127 "0_Src/0_AppSw/Tricore/I2C/I2cBasicDemo.c"
void I2cBasicDemo_start(void)
{ uint32 i;
Ifx_SizeT size;

            g_I2cBasic.data[0]=0x38;
         g_I2cBasic.data[1] = 0x2A;
         g_I2cBasic.data[2] = 0x1;
     size = 2;
...
void I2cAccSensor_init(void)
{
 ...
 g_I2cBasic.data[2] = 0x1;
    ...
    I2CBusStatus=4;
  IfxI2c_I2c_writereg(&g_I2cBasic.i2cDev, g_I2cBasic.data, size);

}



void I2cAccSensor_read(void)
{
    uint32 i;
    Ifx_SizeT size;
# 174 "0_Src/0_AppSw/Tricore/I2C/I2cBasicDemo.c"
   size = 1;
    g_I2cBasic.data[0] = 0x38;
    g_I2cBasic.data[1] = 0x1;

    I2CBusStatus=1;
    IfxI2c_I2c_writereg(&g_I2cBasic.i2cDev, g_I2cBasic.data, size);
# 201 "0_Src/0_AppSw/Tricore/I2C/I2cBasicDemo.c"
}
