# 1 "0_Src/0_AppSw/Tricore/ADC/ADCinit.c"
...
# 9 "0_Src/0_AppSw/Tricore/ADC/ADCinit.c" 2
# 1 "./0_Src/0_AppSw/Tricore/Main/IntPrio.h" 1
# 10 "0_Src/0_AppSw/Tricore/ADC/ADCinit.c" 2


IfxVadc_Adc vadc;
IfxVadc_Adc_Group adcGroup, adc1Group,adc2Group,adc3Group,adc4Group,adc5Group,adc6Group,adc7Group,adc8Group;
IfxVadc_Adc_Channel adcChannel[8], adc1Channel[8],adc2Channel[8],adc3Channel[8],adc4Channel[8],adc5Channel[8],adc6Channel[8],adc7Channel[8];
...
IfxVadc_Adc_ChannelConfig adcChannelConfig[8];
 ...
 for (chnIx=0; chnIx<3; ++chnIx)
              ...
              IfxVadc_Adc_addToQueue(&adcChannel[chnIx], 0);
...
# 47 "0_Src/0_AppSw/Tricore/ADC/ADCinit.c"
void initVADC_TC277(void)
{
# 57 "0_Src/0_AppSw/Tricore/ADC/ADCinit.c"
int chnIx,i;;
...
IfxVadc_Adc_initGroupConfig(&adcGroupConfig, &vadc);
    ...
    IfxVadc_Adc_initGroupConfig(&adcGroupConfig, &vadc);
     ...
     adcGroupConfig.arbiter.requestSlotQueueEnabled = 1;
     adcGroupConfig.arbiter.requestSlotScanEnabled = 1;
     adcGroupConfig.arbiter.requestSlotBackgroundScanEnabled = 1;


     adcGroupConfig.scanRequest.triggerConfig.gatingMode = IfxVadc_GatingMode_gatingHigh ;
     adcGroupConfig.scanRequest.triggerConfig.gatingSource = IfxVadc_GatingSource_0;
     adcGroupConfig.scanRequest.triggerConfig.triggerMode = IfxVadc_TriggerMode_uponRisingEdge;
     adcGroupConfig.scanRequest.triggerConfig.triggerSource = IfxVadc_TriggerSource_15;
    ...
    adcGroupConfig.queueRequest.triggerConfig.gatingMode = IfxVadc_GatingMode_always;
     ...
     adcGroupConfig.scanRequest.requestSlotPrio=IfxVadc_RequestSlotPriority_highest;
     ...
     IfxVadc_Adc_initGroup(&adcGroup, &adcGroupConfig);
        ...
        for (chnIx=0; chnIx<8; ++chnIx)
             ...
             IfxVadc_Adc_addToQueue(&adcChannel[chnIx],(1 << (5)));
     ...
     IfxVadc_Adc_startQueue(&adcGroup);
              ...
              adcGroupConfig.queueRequest.triggerConfig.gatingMode = IfxVadc_GatingMode_always;
               ...
               IfxVadc_Adc_initGroup(&adc1Group, &adcGroupConfig);
                  ...
                  for (chnIx=0; chnIx<8; ++chnIx)
                        {
                       IfxVadc_Adc_initChannelConfig(&adcChannelConfig[chnIx], &adc1Group);
                       adcChannelConfig[chnIx].channelId = (IfxVadc_ChannelId)(chnIx);
                       adcChannelConfig[chnIx].resultRegister = (IfxVadc_ChannelResult)(chnIx);

                       IfxVadc_Adc_initChannel(&adc1Channel[chnIx], &adcChannelConfig[chnIx]);

                       IfxVadc_Adc_addToQueue(&adc1Channel[chnIx],(1 << (5)));
               ...
               IfxVadc_Adc_startQueue(&adc1Group);
         ...
         adcGroupConfig.queueRequest.triggerConfig.gatingMode = IfxVadc_GatingMode_always;
          ...
          IfxVadc_Adc_initGroup(&adc2Group, &adcGroupConfig);
             ...
             for (chnIx=0; chnIx<8; ++chnIx)
                   {
                  IfxVadc_Adc_initChannelConfig(&adcChannelConfig[chnIx], &adc2Group);
                  adcChannelConfig[chnIx].channelId = (IfxVadc_ChannelId)(chnIx);
                  adcChannelConfig[chnIx].resultRegister = (IfxVadc_ChannelResult)(chnIx);

                  IfxVadc_Adc_initChannel(&adc2Channel[chnIx], &adcChannelConfig[chnIx]);

                  IfxVadc_Adc_addToQueue(&adc2Channel[chnIx],(1 << (5)));
          ...
          IfxVadc_Adc_startQueue(&adc2Group);
                ...
                adcGroupConfig.queueRequest.triggerConfig.gatingMode = IfxVadc_GatingMode_always;
                 ...
                 IfxVadc_Adc_initGroup(&adc3Group, &adcGroupConfig);
                    ...
                    for (chnIx=0; chnIx<8; ++chnIx)
                          {
                         IfxVadc_Adc_initChannelConfig(&adcChannelConfig[chnIx], &adc3Group);
                         adcChannelConfig[chnIx].channelId = (IfxVadc_ChannelId)(chnIx);
                         adcChannelConfig[chnIx].resultRegister = (IfxVadc_ChannelResult)(chnIx);

                         IfxVadc_Adc_initChannel(&adc3Channel[chnIx], &adcChannelConfig[chnIx]);

                         IfxVadc_Adc_addToQueue(&adc3Channel[chnIx],(1 << (5)));
                 ...
                 IfxVadc_Adc_startQueue(&adc3Group);
                ...
                adcGroupConfig.queueRequest.triggerConfig.gatingMode = IfxVadc_GatingMode_always;
                 ...
                 IfxVadc_Adc_initGroup(&adc4Group, &adcGroupConfig);
                    ...
                    for (chnIx=0; chnIx<8; ++chnIx)
                 {
                    IfxVadc_Adc_initChannelConfig(&adcChannelConfig[chnIx], &adc4Group);
                    adcChannelConfig[chnIx].channelId = (IfxVadc_ChannelId)(chnIx);
                    adcChannelConfig[chnIx].resultRegister = (IfxVadc_ChannelResult)(chnIx);

                    IfxVadc_Adc_initChannel(&adc4Channel[chnIx], &adcChannelConfig[chnIx]);

                    IfxVadc_Adc_addToQueue(&adc4Channel[chnIx],(1 << (5)));
                 ...
                 IfxVadc_Adc_startQueue(&adc4Group);
                      ...
                      adcGroupConfig.queueRequest.triggerConfig.gatingMode = IfxVadc_GatingMode_always;
                       ...
                       IfxVadc_Adc_initGroup(&adc5Group, &adcGroupConfig);
                          ...
                          for (chnIx=0; chnIx<8; ++chnIx)
                                {
                               IfxVadc_Adc_initChannelConfig(&adcChannelConfig[chnIx], &adc5Group);
                               adcChannelConfig[chnIx].channelId = (IfxVadc_ChannelId)(chnIx);
                               adcChannelConfig[chnIx].resultRegister = (IfxVadc_ChannelResult)(chnIx);

                               IfxVadc_Adc_initChannel(&adc5Channel[chnIx], &adcChannelConfig[chnIx]);

                               IfxVadc_Adc_addToQueue(&adc5Channel[chnIx],(1 << (5)));
                       ...
                       IfxVadc_Adc_startQueue(&adc5Group);



}
# 421 "0_Src/0_AppSw/Tricore/ADC/ADCinit.c"
void initVADC_TC264(void)
{
# 431 "0_Src/0_AppSw/Tricore/ADC/ADCinit.c"
int chnIx,i;;
...
IfxVadc_Adc_initGroupConfig(&adcGroupConfig, &vadc);
    ...
    IfxVadc_Adc_ChannelConfig adcChannelConfig[8];
     ...
     IfxVadc_Adc_startQueue(&adcGroup);
      ...
      adcGroup.group->SEVNP.B.SEV1NP=0x3;

      adcGroup.group->ASMR.B.ENSI=1;
      ...
      IfxSrc_init((Ifx_SRC_SRCR*)&((*(Ifx_SRC *)0xF0038000u)).VADC.G[0].SR3, IfxSrc_Tos_dma, 5);
      IfxSrc_enable((Ifx_SRC_SRCR*)&((*(Ifx_SRC *)0xF0038000u)).VADC.G[0].SR3);



}
# 550 "0_Src/0_AppSw/Tricore/ADC/ADCinit.c"
void initVADC(void)
{ int chnIx,i;;
 ...
 adcGroupConfig.arbiter.requestSlotQueueEnabled = 0;
 adcGroupConfig.arbiter.requestSlotScanEnabled = 1;
 adcGroupConfig.arbiter.requestSlotBackgroundScanEnabled = 0;
    ...
    IfxVadc_Adc_initGroupConfig(&adcGroupConfig, &vadc);
     ...
     IfxVadc_Adc_initGroup(&adc1Group, &adcGroupConfig);
        ...
        for (chnIx=0; chnIx<2; ++chnIx)
            ...
            unsigned channels = (1 << adcChannelConfig[chnIx].channelId);
            unsigned mask = channels;
            IfxVadc_Adc_setScan(&adc1Group, channels, mask);
              }

     IfxVadc_Adc_startScan(&adc1Group);
...
unsigned int GetADCResult(unsigned char numadc,unsigned char numchannel)
{
 if (numadc==0)
 {
 return IfxVadc_Adc_getResult(&adcChannel[numchannel]).B.RESULT;
 }
 if (numadc==1)
    return IfxVadc_Adc_getResult(&adc1Channel[numchannel]).B.RESULT;
 if (numadc==2)
     return IfxVadc_Adc_getResult(&adc2Channel[numchannel]).B.RESULT;
 if (numadc==3)
     return IfxVadc_Adc_getResult(&adc3Channel[numchannel]).B.RESULT;
 if (numadc==4)
     return IfxVadc_Adc_getResult(&adc4Channel[numchannel]).B.RESULT;
 if (numadc==5)
     return IfxVadc_Adc_getResult(&adc5Channel[numchannel]).B.RESULT;
 if (numadc==6)
     return IfxVadc_Adc_getResult(&adc6Channel[numchannel]).B.RESULT;
 if (numadc==7)
     return IfxVadc_Adc_getResult(&adc7Channel[numchannel]).B.RESULT;
 return 0;
